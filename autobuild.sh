...
OVIRT_REPO_URL=http://download.lab.bos.redhat.com/brewroot/repos/rhel-6.0-rhev-h/latest/x86_64/
...
#make iso
cd recipe
make ovirt-node-image.iso PRODUCT='Red Hat Enterprise Virtualization Hypervisor' VERSION=6.0 RELEASE=0.2
